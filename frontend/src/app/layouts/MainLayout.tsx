...
export const MainLayout = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { label: 'Brands', icon: 'pi pi-tag', path: '/masters/brands', section: 'Masters', menuKey: 'masters' },
    { label: 'Dosages', icon: 'pi pi-filter', path: '/masters/dosages', section: 'Masters', menuKey: 'masters' },
    { label: 'Mode of Shipment', icon: 'pi pi-truck', path: '/masters/modes-of-shipment', section: 'Masters', menuKey: 'masters' },
    { label: 'Therapeutic Category', icon: 'pi pi-heart', path: '/masters/therapeutic-categories', section: 'Masters', menuKey: 'masters' },
    { label: 'Currency Conversion', icon: 'pi pi-money-bill', path: '/freight-masters/currency-conversion', section: 'Freight Masters', menuKey: 'masters' },
    { label: 'Containers', icon: 'pi pi-inbox', path: '/freight-masters/containers', section: 'Freight Masters', menuKey: 'masters' },
    { label: 'Transit Days', icon: 'pi pi-calendar', path: '/freight-masters/transit-days', section: 'Freight Masters', menuKey: 'masters' },
    { label: 'Fixed Charges', icon: 'pi pi-calculator', path: '/freight-masters/fixed-charges', section: 'Freight Masters', menuKey: 'masters' },
  ];
